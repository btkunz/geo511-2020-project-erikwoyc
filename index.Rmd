...
# Introduction        I'd be interested to hear a bit more about what sparked your interest in this issue
...
SingleFam20 <- ggmap(basemap) + 
  ...
  labs(title="Distribution of Buffalo Home Prices",
       ...
       caption="Open Data Buffalo")
SingleFam20 I really like both of these maps displaying the home values for different areas of the city, though could you elaborate on the meaning of the numbers in the legend for both of them? As it stands the numbers range from 8 to 14 so I'd be interested to know what those mean.
```
# Conclusions       I'd be interested to see what you feel the spatial distribution of changes in single family home prices means for different neighborhoods of Buffalo!
